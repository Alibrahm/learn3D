...
interface LearningDashboardProps {
  ...
  currentModel?: string
  onProgressUpdate?: (progress: { completedLessons: string[]; totalTimeSpent: number }) => void
}

export function LearningDashboard({ progress, currentModel, onProgressUpdate }: LearningDashboardProps) {
  const lessons = [
    {
      id: 1,
